...
sed -i -z -E "s/#lockDialogGroup \{[^}]+/#lockDialogGroup \{$new_theme_params/g" "$workdir/org/gnome/shell/theme/gnome-shell-light.css"
...
' >>"$workdir/org/gnome/shell/theme/gnome-shell-light.css"

echo '
.login-dialog {
background-color: transparent;
}
' >>"$workdir/org/gnome/shell/theme/gnome-shell-dark.css"
